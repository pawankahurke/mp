...
ln -sf /etc/php-fpm.d/www.conf /etc/php/8.0/fpm/php-fpm.conf

mkdir -p /etc/php/8.2/fpm/pool.d
ln -sf /etc/php-fpm.d/www.conf /etc/php/8.2/fpm/php-fpm.conf
